    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <strong style="font-size: 18px">宣传文章数据管理</strong>
            </div>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="home">
                                ...
                                <script>
                                    layui.use('table', function(){
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: '${pageContext.request.contextPath}/backstage/getPublicityArticle',
                                            dataType: 'json',
                                                ...
                                                if (rdata) {
                                                    const option = {
                                                        ...
                                                        , cols: [[
                                                            ...
                                                            , {field: 'textArea', title: '简要说明', width: 180}
                                                            , {field: 'views', title: '浏览量', width: 100}
                                                            , {field: 'declareDate', title: '发布时间', width: 150, sort: true}
                                                            , {
                                                                field: 'transform',
                                                                title: '跳转页面路径',
                                                                width: 160,
